...
$panels[]     = array(
    ...
    $section    = 'berita_footer_one';
	$sections[] = array(
		'id'       => $section,
		'title'    => __( 'Recommended News One', 'lq-berita' ),
		'priority' => 50,
		'panel'    => $panel_footer,
	);
	
	$options[ $lqbprefix . '_category-footerone' ] = array(
		'id'      => $lqbprefix . '_category-footerone',
		'label'   => __( 'Select Recommended Category', 'lq-berita' ),
		'section' => $section,
		'type'    => 'category-select',
		'default' => '',
	);

    $section    = 'berita_footer_two';
    $sections[] = array(
		'id'       => $section,
		'title'    => __( 'Recommended News Two', 'lq-berita' ),
		'priority' => 50,
		'panel'    => $panel_footer,
	);
	
	$options[ $lqbprefix . '_category-footertwo' ] = array(
		'id'      => $lqbprefix . '_category-footertwo',
		'label'   => __( 'Select Recommended Category', 'lq-berita' ),
		'section' => $section,
		'type'    => 'category-select',
		'default' => '',
