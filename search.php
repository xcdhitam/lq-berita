...
<div class="wrapper">
        ...
        <div class="line-break"><hr></div>
			...
			<header class="page-header">
				<h2 class="page-title">
					...
					printf( esc_html__( 'Search Results for: %s', 'lq-berita' ), '<span>' . get_search_query() . '</span>' );
					?>
				</h2>
			</header><!-- .page-header -->
    ...
    <?php }else { ?>
		...
		<section class="error-404 not-found">
			<header class="page-header">
				<h3 class="page-title"><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'lq-berita' ); ?></h3>
			</header><!-- .page-header -->
		</section><!-- .error-404 -->
		<?php get_search_form() ?>
		<div class="line-break"><hr></div>
